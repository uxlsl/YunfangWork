...
sql = "INSERT INTO anjuke_beijing (`anjuke_id`,`deploy_time`,`Cur_url`,`City`,`District`,`Block`,`Estate`,`Title`,`Price`,`Layout`,`Decoration`,`Location`,`Area`,`Unit_Price`,`Years`,`Orientation`,`Downpayment`,`Type`,`Floor`,`Monthly_Payments`,`Desc`,`Agent`,`Agent_Phone`,`Agent_Company`) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
