...
class CaaDataCrawlPipeline(object):
    ...
    def __init__(self):
        self.CAA_DATA_Tab=Table('CAA_DATA_Tab',self.metadata,
                ...
                Column('Project_ID',VARCHAR(255),primary_key=True),
                Column('Project_Name',VARCHAR(255),index=True),
                Column('City_Name',VARCHAR(255),index=True),
                Column('Area_Code',VARCHAR(255),index=True),
                Column('Area_Name',VARCHAR(255),index=True),
